...
##'   that are right-truncated - moving and modifying
##'
...
##'
##' @param p vector of parameter values c(k, lambda) for which to calculate the negative log-likelihood
...
##' @export
##' @author Andrew Edwards
negLL.Weibull.counts = function(p, h_nr){
    k = p[1]
    lambda = p[2]
